...
# MAIN PAGE
# ------------------------
st.title("🌾 Yield Sense")
st.subheader("🤖 AI-Powered Crop Yield Prediction")
st.markdown(t("Get real-time weather data, soil inputs, and crop-specific recommendations for your farm. Select your location and crop to optimize yield.", lang))

# ------------------------
# FIELD SELECTION (Satellite + Draw + Boundary)
# ------------------------
...
# Add Draw plugin (without export option)
...
if map_data and map_data.get("all_drawings"):
    ...
    if last_drawn["type"] in ["polygon", "rectangle"]:
        ...
        # Draw boundary around the field
        folium.Polygon(
...
if st.button("🔮 " + t("Predict Crop Yield", lang)):
    yield_per_ha = 2450
    predicted_yield = yield_per_ha * field_size
